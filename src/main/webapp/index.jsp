This is a complete HTML document for a modern, animated e-commerce marketplace homepage called "NexusShop". It features a dynamic product grid, category filters, and interactive UI elements.
```html
<!DOCTYPE html>
<html lang="en">
<head>
