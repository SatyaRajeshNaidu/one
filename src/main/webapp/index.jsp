    ...
    <section class="hero container">
      ...
      <div class="services">
        <div class="service">
          ...
          <div><b>Fast delivery</b><span>Across the country</span></div>
        </div>
        <div class="service">
          <i class="fa-solid fa-shield-halved"></i>
          <div><b>Secure checkout</b><span>Protected payments</span></div>
        </div>
        <div class="service">
          <i class="fa-solid fa-rotate-left"></i>
          <div><b>Easy returns</b><span>30-day return window</span></div>
        </div>
        <div class="service">
          <i class="fa-solid fa-headset"></i>
          <div><b>Human support</b><span>We're here to help</span></div>
        </div>
      </div>
    </section>
    ...
    <section class="section container" id="categories">
      ...
      <div class="category-grid" id="categoryGrid">
        <button class="category selected" data-category="all">
          <div class="category-img"><img src="https://images.unsplash.com/photo-1550745165-9bc0b252726f?auto=format&fit=crop&w=500&q=80" alt="All products"></div>
          <strong>Everything</strong><small>120+ items</small>
        </button>
        <button class="category" data-category="technology">
          <div class="category-img"><img src="https://images.unsplash.com/photo-1496181133206-80ce9b88a853?auto=format&fit=crop&w=500&q=80" alt="Technology"></div>
          <strong>Technology</strong><small>32 items</small>
        </button>
        <button class="category" data-category="fashion">
          <div class="category-img"><img src="https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&w=500&q=80" alt="Fashion"></div>
          <strong>Fashion</strong><small>28 items</small>
        </button>
        <button class="category" data-category="audio">
          <div class="category-img"><img src="https://images.unsplash.com/photo-1484704849700-f032a568e944?auto=format&fit=crop&w=500&q=80" alt="Audio"></div>
          <strong>Audio</strong><small>19 items</small>
        </button>
        <button class="category" data-category="travel">
          <div class="category-img"><img src="https://images.unsplash.com/photo-1551632811-561732d1e306?auto=format&fit=crop&w=500&q=80" alt="Travel"></div>
          <strong>Travel</strong><small>16 items</small>
        </button>
        <button class="category" data-category="accessories">
          <div class="category-img"><img src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=500&q=80" alt
